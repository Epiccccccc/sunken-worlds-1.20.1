...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(SunkenWorlds.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, new Identifier(SunkenWorlds.MOD_ID, name),
